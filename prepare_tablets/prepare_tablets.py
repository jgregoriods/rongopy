...
files = [f for f in os.listdir('../tablets') if f.endswith('.csv')]
...
for tablet in tablets_simple:
    ...
    for line in tablets_simple[tablet]:
        ...
        tablets_simple[tablet][line] = '-'.join([i for i in tablets_simple[tablet][line] if i])


def main():
    with open('../tablets/tablets.json', 'w') as file:
        json.dump(tablets, file)
    with open('../tablets/tablets_clean.json', 'w') as file:
        json.dump(tablets_clean, file)
    with open('../tablets/tablets_simple.json', 'w') as file:
        json.dump(tablets_simple, file)
